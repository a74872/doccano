...
from .views.project import (
    ...
    PerspectiveEditView,
    PerspectiveResponseListView,
    PerspectiveResponseCreateView,
    UserPerspectiveResponseView
)
...
urlpatterns = [
    ...
    # Novos endpoints para respostas de perspectiva
    path(route="projects/<int:project_id>/perspective/<int:perspective_id>/responses",
         view=PerspectiveResponseListView.as_view(),
         name="perspective_response_list"),
    path(route="projects/<int:project_id>/perspective/<int:perspective_id>/respond",
         view=PerspectiveResponseCreateView.as_view(),
         name="perspective_response_create"),
    path(route="projects/<int:project_id>/perspective/<int:perspective_id>/my-response",
         view=UserPerspectiveResponseView.as_view(),
         name="user_perspective_response"),
